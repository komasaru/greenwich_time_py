require 'lib/greenwich/angle'
require 'lib/greenwich/cip_cio'
require 'lib/greenwich/era_eors'
require 'lib/greenwich/fundamental_argument'
require 'lib/greenwich/matrix'
require 'lib/greenwich/nutation'
require 'lib/greenwich/precession'
require 'lib/greenwich/rotation_fw'
require 'lib/greenwich/time'

module Greenwich
  include Angle
  include Time
  include FundamentalArgument
  include Matrix

  DIR_LIB = File.expand_path('../greenwich', __FILE__)
